...
public class MemoryGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnHelpMemory).setOnClickListener(v -> mostrarInstruccionesYPista());

        startNewGame();
    }

    private void mostrarInstruccionesYPista() {
        String reglas = "Reglas de Memorama:\n\n" +
                "• Encuentra los pares que relacionan el Artículo con su ejemplo.\n" +
                "• Tienes un límite de tiempo (2 minutos) y 6 vidas.\n" +
                "• El comodín dorado te regala 20 puntos directos.\n\n" +
                "¿Quieres un vistazo rápido de las cartas?";

        new MaterialAlertDialogBuilder(this)
                .setTitle("Información del Juego")
                .setMessage(reglas)
                .setPositiveButton("Usar Vistazo", (dialog, which) -> usarPista())
